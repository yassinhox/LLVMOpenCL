...
int f(Baz *baz) {
	int i = ((Foo_IMPL *)x(((id (*)(id, SEL))(void *)objc_msgSend)(objc_getClass("Baz"), sel_registerName("z"))))->bar;
        int j = ((Foo_IMPL *)((Foo *)((id (*)(id, SEL))(void *)objc_msgSend)(objc_getClass("Baz"), sel_registerName("z"))))->bar;
        int k = ((Foo_IMPL *)x(((id (*)(id, SEL))(void *)objc_msgSend)((id)baz, sel_registerName("y"))))->bar;
        return i+j+k;
}
