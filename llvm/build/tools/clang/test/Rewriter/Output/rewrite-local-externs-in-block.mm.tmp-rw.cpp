...
struct __main_block_impl_0 {
  ...
  int (*myArr)[3];
  __main_block_impl_0(void *fp, struct __main_block_desc_0 *desc, int (*_myArr)[3], int flags=0) : myArr(_myArr) {
...
static void __main_block_func_0(struct __main_block_impl_0 *__cself) {
  int (*myArr)[3] = __cself->myArr; // bound by copy
...
int main() {
	...
	bar((void (*)())&__main_block_impl_0((void *)__main_block_func_0, &__main_block_desc_0_DATA, &myArr));
