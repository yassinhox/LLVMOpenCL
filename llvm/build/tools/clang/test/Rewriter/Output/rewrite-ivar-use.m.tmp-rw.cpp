...
static void foo(id bar) {
        int i = ((Foo_IMPL *)((Foo *)bar))->a;
}


static void _I_Foo_bar(Foo * self, SEL _cmd) {
        ((Foo_IMPL *)self)->a = 42;
        ((void (*)(id, SEL, id))(void *)objc_msgSend)((id)self, sel_registerName("baz:"), (id)((Foo_IMPL *)self)->b);
}
...
static struct {
	...
	,{{"a", "i", __OFFSETOFIVAR__(struct Foo_IMPL, a)}
	  ,{"b", "@", __OFFSETOFIVAR__(struct Foo_IMPL, b)}
	 }
};
...
static struct {
	...
	,{{(SEL)"bar", "v16@0:8", (void *)_I_Foo_bar}
	  ,{(SEL)"baz:", "v24@0:8@16", (void *)_I_Foo_baz_}
	 }
};
