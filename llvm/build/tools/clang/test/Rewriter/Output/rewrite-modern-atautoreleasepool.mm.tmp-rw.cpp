...
__declspec(allocate(".objc_ivar$B")) extern "C" __declspec(dllimport) unsigned long OBJC_IVAR_$_I$ivar;
struct I_IMPL {
	id ivar;
};
...
#line 19 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-atautoreleasepool.mm"
static id _I_I_Meth(I * self, SEL _cmd) {
   /* @autoreleasepool */ { __AtAutoreleasePool __autoreleasepool; 
      id p = ((id (*)(id, SEL))(void *)objc_msgSend)((id)objc_getClass("I"), sel_registerName("MyAlloc"));
      if (!p)
        return (*(id *)((char *)self + OBJC_IVAR_$_I$ivar));
   }
  return 0;
}

#line 27 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-atautoreleasepool.mm"
static id _C_I_MyAlloc(Class self, SEL _cmd) {
    return 0;
}
// @end
...
__declspec(allocate(".objc_ivar$B")) extern "C" __declspec(dllexport) unsigned long int OBJC_IVAR_$_I$ivar __attribute__ ((used, section ("__DATA,__objc_ivar"))) = __OFFSETOFIVAR__(struct I_IMPL, ivar);
...
static struct /*_ivar_list_t*/ {
	...
	sizeof(_ivar_t),
	1,
	{{(unsigned long int *)&OBJC_IVAR_$_I$ivar, "ivar", "@", 3, 8}}
};
...
static struct /*_method_list_t*/ {
	...
	sizeof(_objc_method),
	1,
	{{(struct objc_selector *)"Meth", "@16@0:8", (void *)_I_I_Meth}}
};
...
static struct /*_method_list_t*/ {
	...
	unsigned int method_count;
	struct _objc_method method_list[1];
} _OBJC_$_CLASS_METHODS_I __attribute__ ((used, section ("__DATA,__objc_const"))) = {
	sizeof(_objc_method),
	1,
	{{(struct objc_selector *)"MyAlloc", "@16@0:8", (void *)_C_I_MyAlloc}}
};
...
static struct _class_ro_t _OBJC_METACLASS_RO_$_I __attribute__ ((used, section ("__DATA,__objc_const"))) = {
	...
	0, 
	"I",
	(const struct _method_list_t *)&_OBJC_$_CLASS_METHODS_I,
	0, 
	0, 
	0, 
	0, 
...
static struct _class_ro_t _OBJC_CLASS_RO_$_I __attribute__ ((used, section ("__DATA,__objc_const"))) = {
	2, __OFFSETOFIVAR__(struct I_IMPL, ivar), sizeof(struct I_IMPL), 
	(unsigned int)0, 
	0, 
	"I",
