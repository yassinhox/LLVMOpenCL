...
static void __X__foo_block_copy_1(struct __X__foo_block_impl_1*dst, struct __X__foo_block_impl_1*src) {_Block_object_assign((void*)&dst->self, (void*)src->self, 3/*BLOCK_FIELD_IS_OBJECT*/);}

static void __X__foo_block_dispose_1(struct __X__foo_block_impl_1*src) {_Block_object_dispose((void*)src->self, 3/*BLOCK_FIELD_IS_OBJECT*/);}
...
static void __X__foo_block_copy_2(struct __X__foo_block_impl_2*dst, struct __X__foo_block_impl_2*src) {_Block_object_assign((void*)&dst->self, (void*)src->self, 3/*BLOCK_FIELD_IS_OBJECT*/);}

static void __X__foo_block_dispose_2(struct __X__foo_block_impl_2*src) {_Block_object_dispose((void*)src->self, 3/*BLOCK_FIELD_IS_OBJECT*/);}

static struct __X__foo_block_desc_2 {
  unsigned long reserved;
  unsigned long Block_size;
  void (*copy)(struct __X__foo_block_impl_2*, struct __X__foo_block_impl_2*);
  void (*dispose)(struct __X__foo_block_impl_2*);
} __X__foo_block_desc_2_DATA = { 0, sizeof(struct __X__foo_block_impl_2), __X__foo_block_copy_2, __X__foo_block_dispose_2};
