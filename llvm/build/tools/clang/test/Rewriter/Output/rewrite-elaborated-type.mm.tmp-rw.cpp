...
static id _I_NSConcretePointerFunctions_initWithOptions_(NSConcretePointerFunctions * self, SEL _cmd, NSPointerFunctionsOptions options) {
      if (!((bool (*)(id, SEL, struct NSSlice *, NSPointerFunctionsOptions))(void *)objc_msgSend)((id)NSClassFromObject(self), sel_registerName("initializeSlice:withOptions:"), &((NSConcretePointerFunctions_IMPL *)self)->slice, (NSPointerFunctionsOptions)options))
        return 0;
      return self;
  }
...
} _OBJC_INSTANCE_VARIABLES_NSConcretePointerFunctions __attribute__ ((used, section ("__OBJC, __instance_vars")))= {
	1
	,{{"slice", "{NSSlice=\"i1\"i}", __OFFSETOFIVAR__(struct NSConcretePointerFunctions_IMPL, slice)}
	 }
};
...
} _OBJC_INSTANCE_METHODS_NSConcretePointerFunctions __attribute__ ((used, section ("__OBJC, __inst_meth")))= {
	0, 2
	,{{(SEL)"initWithOptions:", "@20@0:8I16", (void *)_I_NSConcretePointerFunctions_initWithOptions_}
	  ,{(SEL)"initializeSlice:withOptions:", "B28@0:8^{NSSlice=i}16I24", (void *)_I_NSConcretePointerFunctions_initializeSlice_withOptions_}
	 }
};
...
static struct _objc_class _OBJC_METACLASS_NSConcretePointerFunctions __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"NSConcretePointerFunctions", 0, "NSConcretePointerFunctions", 0,2, sizeof(struct _objc_class), 0, 0
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_NSConcretePointerFunctions __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_NSConcretePointerFunctions, 0, "NSConcretePointerFunctions", 0,1,sizeof(struct NSConcretePointerFunctions_IMPL), (struct _objc_ivar_list *)&_OBJC_INSTANCE_VARIABLES_NSConcretePointerFunctions
	, (struct _objc_method_list *)&_OBJC_INSTANCE_METHODS_NSConcretePointerFunctions, 0
	,0,0,0
};
...
} _OBJC_CLASS_METHODS_I1 __attribute__ ((used, section ("__OBJC, __cls_meth")))= {
	0, 1
	,{{(SEL)"f0", "^{s1=}16@0:8", (void *)_C_I1_f0}
	 }
};

static struct _objc_class _OBJC_METACLASS_I1 __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"I1", 0, "I1", 0,2, sizeof(struct _objc_class), 0
	, (struct _objc_method_list *)&_OBJC_CLASS_METHODS_I1
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_I1 __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_I1, 0, "I1", 0,1,0,0,0,0,0,0,0
};
...
static struct _objc_symtab _OBJC_SYMBOLS __attribute__((used, section ("__OBJC, __symbols")))= {
	0, 0, 2, 0
	,&_OBJC_CLASS_NSConcretePointerFunctions
	,&_OBJC_CLASS_I1
};
