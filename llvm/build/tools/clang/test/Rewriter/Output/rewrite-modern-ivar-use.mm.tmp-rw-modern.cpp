...
__declspec(allocate(".objc_ivar$B")) extern "C" __declspec(dllimport) unsigned long OBJC_IVAR_$_Foo$a;
struct Foo_IMPL {
	int a;
	id b;
};
...
#line 16 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-ivar-use.mm"
static void foo(id bar) {
        int i = (*(int *)((char *)((Foo *)bar) + OBJC_IVAR_$_Foo$a));
}


#line 20 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-ivar-use.mm"
static void _I_Foo_bar(Foo * self, SEL _cmd) {
        (*(int *)((char *)self + OBJC_IVAR_$_Foo$a)) = 42;
}

#line 23 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-ivar-use.mm"
static void _I_Foo_baz_(Foo * self, SEL _cmd, id q) {
}
// @end
...
__declspec(allocate(".objc_ivar$B")) extern "C" __declspec(dllexport) unsigned long int OBJC_IVAR_$_Foo$a __attribute__ ((used, section ("__DATA,__objc_ivar"))) = __OFFSETOFIVAR__(struct Foo_IMPL, a);
__declspec(allocate(".objc_ivar$B")) extern "C" __declspec(dllexport) unsigned long int OBJC_IVAR_$_Foo$b __attribute__ ((used, section ("__DATA,__objc_ivar"))) = __OFFSETOFIVAR__(struct Foo_IMPL, b);
...
static struct /*_ivar_list_t*/ {
	...
	sizeof(_ivar_t),
	2,
	{{(unsigned long int *)&OBJC_IVAR_$_Foo$a, "a", "i", 2, 4},
	 {(unsigned long int *)&OBJC_IVAR_$_Foo$b, "b", "@", 3, 8}}
};
...
static struct /*_method_list_t*/ {
	...
	{(struct objc_selector *)"baz:", "v24@0:8@16", (void *)_I_Foo_baz_}}
};
...
static struct _class_ro_t _OBJC_CLASS_RO_$_Foo __attribute__ ((used, section ("__DATA,__objc_const"))) = {
	2, __OFFSETOFIVAR__(struct Foo_IMPL, a), sizeof(struct Foo_IMPL), 
	(unsigned int)0, 
	0, 
	"Foo",
