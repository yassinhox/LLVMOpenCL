...
struct __Block_byref_s_0 {
  void *__isa;
__Block_byref_s_0 *__forwarding;
 int __flags;
 int __size;
 struct _s *s;
};
...
struct __f_block_impl_0 {
  ...
  __Block_byref_s_0 *s; // by ref
  __f_block_impl_0(void *fp, struct __f_block_desc_0 *desc, __Block_byref_s_0 *_s, int flags=0) : s(_s->__forwarding) {
...
static void __f_block_func_0(struct __f_block_impl_0 *__cself) {
  __Block_byref_s_0 *s = __cself->s; // bound by ref

        (s->__forwarding->s) = (struct _s *)r();
    }
static void __f_block_copy_0(struct __f_block_impl_0*dst, struct __f_block_impl_0*src) {_Block_object_assign((void*)&dst->s, (void*)src->s, 8/*BLOCK_FIELD_IS_BYREF*/);}

static void __f_block_dispose_0(struct __f_block_impl_0*src) {_Block_object_dispose((void*)src->s, 8/*BLOCK_FIELD_IS_BYREF*/);}
...
void f() {
    __block __Block_byref_s_0 s = {(void*)0,(__Block_byref_s_0 *)&s, 0, sizeof(__Block_byref_s_0), 0};
    a((void (*)(void))&__f_block_impl_0((void *)__f_block_func_0, &__f_block_desc_0_DATA, (struct __Block_byref_s_0 *)&s, 570425344));
}
