...
__declspec(allocate(".objc_ivar$B")) extern "C" __declspec(dllimport) unsigned long OBJC_IVAR_$_Foo$_block;
struct Foo_IMPL {
	void (*_block)(void);
};
...
#line 12 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-block-ivar-call.mm"
static void _I_Foo_bar(Foo * self, SEL _cmd) {
    ((void (*)(struct __block_impl *))((struct __block_impl *)(*(void (**)(void))((char *)self + OBJC_IVAR_$_Foo$_block)))->FuncPtr)((struct __block_impl *)(*(void (**)(void))((char *)self + OBJC_IVAR_$_Foo$_block)));
}
// @end
...
__declspec(allocate(".objc_ivar$B")) extern "C" __declspec(dllexport) unsigned long int OBJC_IVAR_$_Foo$_block __attribute__ ((used, section ("__DATA,__objc_ivar"))) = __OFFSETOFIVAR__(struct Foo_IMPL, _block);
...
static struct /*_ivar_list_t*/ {
	...
	sizeof(_ivar_t),
	1,
	{{(unsigned long int *)&OBJC_IVAR_$_Foo$_block, "_block", "@?", 3, 8}}
};
...
static struct _class_ro_t _OBJC_CLASS_RO_$_Foo __attribute__ ((used, section ("__DATA,__objc_const"))) = {
	2, __OFFSETOFIVAR__(struct Foo_IMPL, _block), sizeof(struct Foo_IMPL), 
	(unsigned int)0, 
	0, 
	"Foo",
