...
extern "C" {
// @class CCC;
#ifndef _REWRITER_typedef_CCC
#define _REWRITER_typedef_CCC
typedef struct objc_object CCC;
#endif
...
typedef struct objc_object Protocol;
#endif
#ifndef _REWRITER_typedef_P
#define _REWRITER_typedef_P
typedef struct objc_object P;
#endif
#ifndef _REWRITER_typedef_Q
#define _REWRITER_typedef_Q
typedef struct objc_object Q;
#endif
