...
static struct {
	...
	0, 1
	,{{(SEL)"processStuff", "v16@0:8", (void *)_I_a_processStuff}
	 }
};
...
static struct _objc_class _OBJC_METACLASS_a __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"a", 0, "a", 0,2, sizeof(struct _objc_class), 0, 0
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_a __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_a, 0, "a", 0,1,0,0, (struct _objc_method_list *)&_OBJC_INSTANCE_METHODS_a, 0
	,0,0,0
};
...
static struct {
	...
	0, 1
	,{{(SEL)"processStuff", "v16@0:8", (void *)_I_b_processStuff}
	 }
};

static struct _objc_class _OBJC_METACLASS_b __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"b", 0, "b", 0,2, sizeof(struct _objc_class), 0, 0
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_b __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_b, 0, "b", 0,1,0,0, (struct _objc_method_list *)&_OBJC_INSTANCE_METHODS_b, 0
	,0,0,0
};
