...
} _OBJC_INSTANCE_VARIABLES_CoreDAVTaskGroup __attribute__ ((used, section ("__OBJC, __instance_vars")))= {
	1
	,{{"IVAR", "i", __OFFSETOFIVAR__(struct CoreDAVTaskGroup_IMPL, IVAR)}
	 }
};
...
} _OBJC_INSTANCE_METHODS_CoreDAVTaskGroup __attribute__ ((used, section ("__OBJC, __inst_meth")))= {
	0, 2
	,{{(SEL)"_finishInitialSync", "v16@0:8", (void *)_I_CoreDAVTaskGroup__finishInitialSync}
	  ,{(SEL)"setCompletionBlock:", "v24@0:8@?16", (void *)_I_CoreDAVTaskGroup_setCompletionBlock_}
	 }
};
...
static struct _objc_class _OBJC_METACLASS_CoreDAVTaskGroup __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"CoreDAVTaskGroup", 0, "CoreDAVTaskGroup", 0,2, sizeof(struct _objc_class), 0, 0
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_CoreDAVTaskGroup __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_CoreDAVTaskGroup, 0, "CoreDAVTaskGroup", 0,1,sizeof(struct CoreDAVTaskGroup_IMPL), (struct _objc_ivar_list *)&_OBJC_INSTANCE_VARIABLES_CoreDAVTaskGroup
	, (struct _objc_method_list *)&_OBJC_INSTANCE_METHODS_CoreDAVTaskGroup, 0
	,0,0,0
};
