...
static void _I_NSMessagePort_clone(NSMessagePort * self, SEL _cmd) {
...
} _OBJC_INSTANCE_METHODS_NSMessagePort __attribute__ ((used, section ("__OBJC, __inst_meth")))= {
	0, 1
	,{{(SEL)"clone", "v16@0:8", (void *)_I_NSMessagePort_clone}
	 }
};
...
static struct _objc_class _OBJC_METACLASS_NSMessagePort __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"NSMessagePort", 0, "NSMessagePort", 0,2, sizeof(struct _objc_class), 0, 0
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_NSMessagePort __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_NSMessagePort, 0, "NSMessagePort", 0,1,0,0, (struct _objc_method_list *)&_OBJC_INSTANCE_METHODS_NSMessagePort, 0
	,0,0,0
};
