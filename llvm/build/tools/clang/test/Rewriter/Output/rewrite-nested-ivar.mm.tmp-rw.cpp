...
static void _I_NSCachedURLResponse_Meth(NSCachedURLResponse * self, SEL _cmd) {
    ((NSURLResponse_IMPL *)((NSCachedURLResponseInternal_IMPL *)((NSCachedURLResponse_IMPL *)self)->_internal)->response)->InnerResponse = 0;
  }
// @end
...
} _OBJC_INSTANCE_VARIABLES_NSCachedURLResponse __attribute__ ((used, section ("__OBJC, __instance_vars")))= {
	1
	,{{"_internal", "@\"NSCachedURLResponseInternal\"", __OFFSETOFIVAR__(struct NSCachedURLResponse_IMPL, _internal)}
	 }
};
...
} _OBJC_INSTANCE_METHODS_NSCachedURLResponse __attribute__ ((used, section ("__OBJC, __inst_meth")))= {
	0, 1
	,{{(SEL)"Meth", "v16@0:8", (void *)_I_NSCachedURLResponse_Meth}
	 }
};
...
static struct _objc_class _OBJC_METACLASS_NSCachedURLResponse __attribute__ ((used, section ("__OBJC, __meta_class")))= {
	(struct _objc_class *)"NSCachedURLResponse", 0, "NSCachedURLResponse", 0,2, sizeof(struct _objc_class), 0, 0
	,0,0,0,0
};

static struct _objc_class _OBJC_CLASS_NSCachedURLResponse __attribute__ ((used, section ("__OBJC, __class")))= {
	&_OBJC_METACLASS_NSCachedURLResponse, 0, "NSCachedURLResponse", 0,1,sizeof(struct NSCachedURLResponse_IMPL), (struct _objc_ivar_list *)&_OBJC_INSTANCE_VARIABLES_NSCachedURLResponse
	, (struct _objc_method_list *)&_OBJC_INSTANCE_METHODS_NSCachedURLResponse, 0
	,0,0,0
};
...
static struct _objc_symtab _OBJC_SYMBOLS __attribute__((used, section ("__OBJC, __symbols")))= {
	0, 0, 1, 0
	,&_OBJC_CLASS_NSCachedURLResponse
};
