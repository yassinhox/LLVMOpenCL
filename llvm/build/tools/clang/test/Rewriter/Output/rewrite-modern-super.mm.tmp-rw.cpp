...
#line 18 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-super.mm"
static void _I_I_dealloc(I * self, SEL _cmd) {
    return;
    ((void (*)(__rw_objc_super *, SEL))(void *)objc_msgSendSuper)((__rw_objc_super *)&__rw_objc_super((id)self, (id)class_getSuperclass(objc_getClass("I"))), sel_registerName("dealloc"));
}
// @end
...
static struct /*_method_list_t*/ {
	...
	sizeof(_objc_method),
	1,
	{{(struct objc_selector *)"dealloc", "v16@0:8", (void *)_I_I_dealloc}}
};
...
extern "C" __declspec(dllimport) struct _class_t OBJC_METACLASS_$_Sub;
...
extern "C" __declspec(dllimport) struct _class_t OBJC_CLASS_$_Sub;
...
static void OBJC_CLASS_SETUP_$_I(void ) {
	OBJC_METACLASS_$_I.isa = &OBJC_METACLASS_$_Sub;
	OBJC_METACLASS_$_I.superclass = &OBJC_METACLASS_$_Sub;
	OBJC_METACLASS_$_I.cache = &_objc_empty_cache;
	OBJC_CLASS_$_I.isa = &OBJC_METACLASS_$_I;
	OBJC_CLASS_$_I.superclass = &OBJC_CLASS_$_Sub;
