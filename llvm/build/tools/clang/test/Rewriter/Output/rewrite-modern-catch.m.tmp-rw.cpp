...
#line 13 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-catch.m"
static void _I_Foo_bar(Foo * self, SEL _cmd) {
    try {
    } 
#line 15 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-catch.m"
catch (_objc_exc_NSException *_e) { NSException *e = (NSException*)_e; 
	foo(e);
    }
    
#line 18 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-catch.m"
catch (_objc_exc_Foo *_f) { Foo *f = (Foo*)_f; 
    }
    catch (...) {
      try {
      }
      
#line 23 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-catch.m"
catch (_objc_exc_Foo *_f1) { Foo *f1 = (Foo*)_f1; 
	foo(f1);
      }
      catch (id pid) {
	foo(pid);
