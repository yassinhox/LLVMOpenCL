...
#line 19 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-try-finally.m"
static void _I_Foo_bar(Foo * self, SEL _cmd) {
    
#line 20 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-try-finally.m"
{ id volatile _rethrow = 0;
try {
	TRY();
    } 
    
#line 23 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-try-finally.m"
...
#line 27 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-try-finally.m"
{ id volatile _rethrow = 0;
try {
	TRY();
    } 
    
#line 30 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-try-finally.m"
catch (id e) {_rethrow = e;}
 { struct _FIN { _FIN(id reth) : rethrow(reth) {}
	~_FIN() { if (rethrow) objc_exception_throw(rethrow); }
	id rethrow;
...
#line 31 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-try-finally.m"
{ id volatile _rethrow = 0;
try {
        INNER_TRY();
      }
      
#line 34 "/home/jazouani/llvm/llvm-3.2/tools/clang/test/Rewriter/rewrite-modern-try-finally.m"
catch (id e) {_rethrow = e;}
 { struct _FIN { _FIN(id reth) : rethrow(reth) {}
	~_FIN() { if (rethrow) objc_exception_throw(rethrow); }
	id rethrow;
